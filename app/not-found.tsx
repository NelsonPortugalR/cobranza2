...
import { SearchRedirect } from "@/components/SearchRedirect.tsx";

export default function NotFound() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-24 text-center sm:px-6">
      <h1 className="font-serif text-4xl">This page isn&rsquo;t here</h1>
      <p className="mt-4 text-piedra">The product may have sold out, moved, or been removed because it isn&rsquo;t alpaca.</p>
      <div className="mx-auto mt-8 max-w-xl text-left">
        <SearchRedirect />
      </div>
      <p className="mt-8 text-sm text-piedra">Or browse a category:</p>
